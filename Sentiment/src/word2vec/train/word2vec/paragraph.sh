cp ../scripts/word2vec.c
gcc word2vec.c -o word2vec -lm -pthread -O3 -march=native -funroll-loops

cat ../data/full-train-pos.txt ../data/full-train-neg.txt ../data/full-test.txt ../data/full-unlabeled.txt > ./alldata.txt
awk 'BEGIN{a=0;}{print "_*" a " " $0; a++;}' < ./alldata_org.txt > ./alldata-id.txt
